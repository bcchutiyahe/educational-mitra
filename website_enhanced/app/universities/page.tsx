...
export const metadata: Metadata = {
  title: '100+ Partner Universities | MBA, BBA, B.Tech Colleges Indore | Educational Mitra',
  description: 'Browse 100+ partner universities of Educational Mitra across Indore, MP and India. Direct MOUs with top MBA, BBA, B.Tech, Law and Medical colleges.',
  keywords: 'partner universities Indore, MBA colleges Indore, BBA colleges Indore, top universities MP, best colleges Madhya Pradesh, Educational Mitra universities',
}
